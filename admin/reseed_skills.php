...
<main class="main-content">
    ...
    <div class="reseed-card">
        <?php if ($done): ?>
        <div class="success-box"><i class="fas fa-check-circle fa-lg"></i><div><strong>Done!</strong> Toolkit reseeded with 30 skills across 6 categories.</div></div>
        ...
        <p>Replaces all existing skills with <strong>30 updated skills</strong> across 6 categories. Currently <strong><?= $count ?> skills</strong> in database.</p>
